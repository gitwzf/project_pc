            ...
            <div id="body" style="clear:left">
                <dl class="content">
					...
					<dd>
						...
						<input size="30" name="WIDseller_email" value="${indexform.WIDseller_email }" />
						<span></span>
					</dd>
					<dt>商户订单号：</dt>
					<dd>
						<span class="null-star">*</span>
						<input size="30" name="WIDout_trade_no" value="${indexform.WIDout_trade_no }"/>
						<span></span>
					</dd>
					<dt>订单名称：</dt>
					<dd>
						<span class="null-star">*</span>
						<input size="30" name="WIDsubject"  value="${indexform.WIDsubject }" />
						<span></span>
					</dd>
                    <dt>付款金额：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDtotal_fee" value="${indexform.WIDtotal_fee}"  />
                        <span></span>
                    </dd>
                    <dt></dt>
                    <dd>
