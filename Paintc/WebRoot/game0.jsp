...
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0">
    <title>清凉一夏 萌宝抽奖</title>
    <script type="text/javascript" src="js/jquery-1.7.2.min.js"></script>
    <script type="text/javascript" src="js/index.js?f=4"></script>
     <link href="css/css.css" rel="stylesheet" />
    <link rel="stylesheet" type="text/css" href="css/game.css?y=8">
    ...
    <img src="images/title2.png" class="title"/>
        ...
        <c:if test="${empty user.cjstate}">
            ...
            <img id="expri-img" src="images/win-${user.cjstate+1}.gif" border=0 />
                ...
                <c:if test="${user.cjstate==2}"><div class="tips">恭喜你中了无敌幸运奖！</div></c:if>
                <c:if test="${user.cjstate==3}"><div class="tips">可惜了，到手的奖飞走了！</div></c:if>
                <c:if test="${user.cjstate==4}"><div class="tips">你领过勒！！</div></c:if>
		...
		<div class="per-info">
			...
			<p>扫描二维码  或搜索klxy0571关注微信订阅号 “爱童学”参与抽奖</p>
