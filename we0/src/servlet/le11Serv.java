...
//		}
		...
		log.info("le11Serv(get) name:"+name+" type:"+type);
//		log.info("type="+type);
		if(name!=null)
		try {
...
//		}
        ...
        String module=req.getParameter("module");
        	log.info("le11Serv(post) name:"+name+" module:"+module);
   //module 
        ...
        if("basic".equals(module)){
        	...
        	log.info("le11Serv(post) content:"+content);
        ...
        if("news".equals(module)){
        	...
        	log.info("le11Serv(post) pic_count:"+pic_count);
...
//            String ntypeid[]=req.getParameterValues("news-typeid[]");
            ...
            try {
		        	String n_id=db.addNesItem("1", ntitle,nmain,nurlo,nurl,pic_count);
        ...
        if("music".equals(module)){
             ...
             log.info("le11Serv(post) mtitle:"+mtitle);
