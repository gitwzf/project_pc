...
<head>
<link rel="Shortcut Icon" href="http://ecs.touclick.com/favicon.ico">
...
" target="main">活动报名<i class="arrow"></i></a></li>	
									...
									<ul class="snav unstyled">
												...
												<ul class="snav unstyled">
														...
														<li class="snav-header"><a href="">新闻管理<i class="arrow"></i></a></li>
																			...
																			<li class="snav-list"><a href="" target="main">类别<i class="arrow"></i></a></li>
											                                      </ul>
												<ul class="snav unstyled">
												<ul class="snav unstyled">
