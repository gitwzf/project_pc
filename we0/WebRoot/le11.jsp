...
<span style="cursor:pointer;"></span><input type="file" tabindex="-1" name="imgFile" style="width: 100px;" onchange="picsub('')"></form></div>或直接填写url<input type="text" value="<%=retxt==null?"":retxt.news[0].urlo%>" name="news-picture-new[news-wrap-item-0][]"/>
	...
	<tr>
		<th>相关链接</th>
		<td>
			<input type="text" value="<%=retxt==null?"":(r>0?retxt.news[0].url:"")%>" name="news-url-new[news-wrap-item-0][]" placeholder="" class="span7" id="">
...
<a href="javascript:;" onclick="showitem()" class="btn"><i class="icon-plus"></i> 添加多条内容</a></div></div>  
</script> 
</div> 
</script> 
</div> 
