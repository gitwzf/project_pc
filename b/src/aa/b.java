...
public class b {
	...
	public static void main(String[] args) throws Exception {
		...
		String jstr1=returnUrl(getInterfaceURL("101010100", "index", todate));
		String jstr2=returnUrl(getInterfaceURL("101010100", "forecast3d", todate));
		String jstr3=returnUrl(getInterfaceURL("101010100", "observe", todate));
