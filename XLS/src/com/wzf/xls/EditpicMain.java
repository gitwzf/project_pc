...
//			}
			File f=new File("D:/点触图片/overall_441_600");
			File[] ff=f.listFiles();
			for(File file:ff)
				file.renameTo(new File("D:/点触图片/overall_441_600/"+file.getName()+map.get(file.getName())));
	 ...
	 private static Map<String,String> readXls() throws IOException {
		 InputStream is = new FileInputStream("d://pic.xlsx");
