...
function gethits($filename,$user){
	...
	$hits = 0; //如果记录文件不存在,则初始化次数为0
		...
		$hits = (int)$hits;
		if(!checkIP($_SERVER['REMOTE_ADDR'],$user))
			$hits ++;
	}
