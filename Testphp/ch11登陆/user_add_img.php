...
<html>
	...
	<body>
		<?php
			...
			$rand = $_POST["Rand"];
			$sys_rand = $_SESSION["num"];
			//判断用户输入的验证码是否正确
			if($sys_rand != null  && ($rand == $sys_rand)){
				...
				echo ("<h1 align=center>您输入的验证码错误</h1>");
				echo ("<div align=center><input type=button name=btn3 value=返回 onClick='window.history.go(-1)'></div>");
			}
		?>
	</body>
</html>