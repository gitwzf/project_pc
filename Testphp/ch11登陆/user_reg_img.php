...
<html>
	...
	<body>
		...
		<div align="center">
			<form name="reg" action="user_add_img.php" method="post" target="_self" onSubmit="return docheck()">
			<table width="90%" border="0">		
				...
				<tr>
					<td width="50%" align="right"  height="25">请输入验证码：</td>
					<td width="50%" align="left"  height="25">&nbsp;<input type="text" name="Rand" maxlength="5" size="5">&nbsp;<img border=0 src="image.php"></td>
				</tr>
			</table>
			<p>
