...
<!-- 主要部分 -->
 ...
 <TR>
  <TD height=18 background='images/bg3.gif' valign=bottom>
   ...
   <font color=#FFFFFF> <? echo $cate_name; ?>列表 </font>
   <font color="<? echo $message[14]; ?>">■</font>
   ...............................
   </TD>
  </TR>
...
<?php
	$query = "SELECT singer_id, alpha, singer_name, cd_num, song_num, click FROM singer WHERE cate_id = '$cate_id' ORDER BY alpha";
	...
	while($tmp = $db->fetch_array($result)) {
		...
		$c = "<a href=\"singer.php?cate_id=$cate_id&cate_name=".urlencode($cate_name)
