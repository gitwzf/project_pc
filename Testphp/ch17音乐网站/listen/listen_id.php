...
$db = new db_class;
$db->connect();
$db->query("UPDATE song SET click=click+1 WHERE song_id = '$song_id'");
$song_url = $db->query_first("SELECT rm_url FROM song WHERE song_id = '$song_id'");
if(islogin()) 
{ 
...
$song_url = str_replace(' ','%20',$song_url[0]);
