...
<div class="login-hd">
	...
	<div class="badge-info"><a href="http://" target="_blank">平台</a></div>
</div>
	...
	<table class="table">
		...
		<tr>
			<td><label for="remember" class="checkbox inline"><input type="checkbox" name="rember" value="1" id="remember"> 记住账号</label></td>
				<td><label for="remember" class="checkbox inline"><input type="checkbox" name="saveTime" value="1"> 自动登陆</label></td>
